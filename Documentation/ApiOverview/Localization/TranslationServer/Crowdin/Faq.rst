...
#.  Go to your extension in Crowdin, select the :guilabel:`Sources` tab.
#.  Search for the branch, for example `master`, and right-click on the branch
    name.
#.  Choose :guilabel:`Rename` and complete the renaming process.
#.  Rename `master` to `main` in your Git repository.
#.  In Crowdin, go to :guilabel:`Integrations` and edit your Git integration,
    specifying the new `main` branch.
